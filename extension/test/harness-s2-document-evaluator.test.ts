...
it('navigation during observation cannot publish a coherent old snapshot',async()=>{const m=await import(moduleUrl);await expect(m.withObservedDocument(7,'main',async()=>{doc='replaced';
