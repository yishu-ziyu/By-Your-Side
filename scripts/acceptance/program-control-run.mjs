...
return es.some(e=>e.msg?.type==='status');},'initial status');
...
return es.some(e=>e.at>=result.takeoverRequestedAt&&e.msg?.type==='control_result'&&e.msg.action==='takeover'&&e.msg.ok)||es.some(e=>e.at>=result.takeoverRequestedAt&&e.msg?.type==='status'&&e.msg.state==='user');},'takeover acknowledged',30000);
