...
server.listen(port,'127.0.0.1',()=>{const address=server.address();

if(address&&typeof address!=='string')console.log(`P0 synthetic fixture: http://127.0.0.1:${address.port}/\n仅服务本机虚构数据；不会启动浏览器或模型。Ctrl-C 停止。`);});
