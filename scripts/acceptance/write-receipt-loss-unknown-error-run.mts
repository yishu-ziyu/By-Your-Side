/** Independent browser counterexample, derived from the frozen driver. Only fault and RPC wiring vary.
...
const out=await mkdtemp(join(tmpdir(),'ego-write-receipt-unknown-error-'));
