...
if(typeof value!=='number'||!Number.isFinite(value)||value<0||value>1)return fallback('invalid_response');
 }
...
return {...composeAtomic(raw.answers??{},true),raw,elapsedMs:performance.now()-started};
