...
[快速开始](#安装) · [功能](#可以做什么) · [语音](#语音交互) · [路线图](docs/ROADMAP.md) · [架构](docs/architecture.md) · [当前进度与验收](docs/STATUS.md)
...
任务所需的文字、页面内容或截图会发送给你配置的模型服务；语音输入会发送给阶跃服务；可选的 Jev 显示判断使用 TypeSafe 服务。**本地伴随进程不意味着模型推理离线。**
