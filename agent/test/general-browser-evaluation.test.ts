...
if(mode==='self-authored')f.bundle.provenance.kind='development';

if(mode==='same-site')f.bundle.tasks.forEach(t=>t.siteId='same');

if(mode==='missing-category')f.bundle.tasks=f.bundle.tasks.slice(0,23);

if(mode==='same-family')f.bundle.tasks[1]!.familyId=f.bundle.tasks[0]!.familyId;
