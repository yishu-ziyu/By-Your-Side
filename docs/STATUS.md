...
| 没做完的一行、步骤清单、回答平滑显示（2026-09-25） | 那一行写用户原话里没做成的事、不给「继续」，3/3 通过；步骤清单平铺；回答逐字淡入后底线 3 条通过 | 依赖模型填 `unfinished`，有 1 次未配合；淡入手感待人判断；未加载日常；[验收](evals/20260925-unfinished-line-and-answer-reveal.md) |
